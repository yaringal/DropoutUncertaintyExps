...
if (len(sys.argv) != 2):
    ...
    print ('Example format: python experiment_10x_epochs.py bostonHousing')
    exit(1)
...
_RESULTS_VALIDATION_LL = "/UCI_Datasets/" + data_directory + "/results/results_10x_epochs/validation_ll.txt"
_RESULTS_VALIDATION_RMSE = "/UCI_Datasets/" + data_directory + "/results/results_10x_epochs/validation_rmse.txt"
_RESULTS_VALIDATION_MC_RMSE = "/UCI_Datasets/" + data_directory + "/results/results_10x_epochs/validation_MC_rmse.txt"

_RESULTS_TEST_LL = "/UCI_Datasets/" + data_directory + "/results/results_10x_epochs/test_ll.txt"
_RESULTS_TEST_RMSE = "/UCI_Datasets/" + data_directory + "/results/results_10x_epochs/test_rmse.txt"
_RESULTS_TEST_MC_RMSE = "/UCI_Datasets/" + data_directory + "/results/results_10x_epochs/test_MC_rmse.txt"
_RESULTS_TEST_TIME = "/UCI_Datasets/" + data_directory + "/results/results_10x_epochs/time.txt"
_RESULTS_TEST_LOG = "/UCI_Datasets/" + data_directory + "/results/results_10x_epochs/log.txt"
    ...
    for dropout_rate in dropout_rates:
        for tau in tau_values:
            ...
            network = net.net(X_train, y_train,
                [ int(n_hidden) ], normalize = True, n_epochs = int(n_epochs*100), tau = tau,
