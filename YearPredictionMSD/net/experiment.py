...
# We load the data
folder = '' # data too big to fit in repo; please get in touch for dataset

data = np.loadtxt(folder + '../data/data.txt')

# We load the number of hidden units

n_hidden = np.loadtxt(folder + '../data/n_hidden.txt').tolist()

# We load the number of training epocs

n_epochs = np.loadtxt(folder + '../data/n_epochs.txt').tolist()

# We load the indexes for the features and for the target

index_features = np.loadtxt(folder + '../data/index_features.txt')
index_target = np.loadtxt(folder + '../data/index_target.txt')
...
n_splits = np.loadtxt(folder + '../data/n_splits.txt')
...
for i in range(n_splits):
    ...
    index_train = np.loadtxt(folder + "../data/index_train_{}.txt".format(i))
    index_test = np.loadtxt(folder + "../data/index_test_{}.txt".format(i))
