...
class net:
    ...
    def __init__(self, X_train, y_train, n_hidden, n_epochs = 40,
        ...
        # modeltest = ModelTest(X_test, y_test, test_every_X_epochs=5, verbose=0, T=100, 
        ...
        scheduler = LearningRateScheduler(lambda epoch: 0.001 / (epoch+1)**0.5)
        model.fit(X_train, y_train_normalized, batch_size=batch_size, nb_epoch=n_epochs, verbose=1, 
            callbacks=[scheduler]) #, modeltest
        self.model = model
        self.tau = tau
